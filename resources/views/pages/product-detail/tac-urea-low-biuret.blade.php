...
@section('content')
    <div class="container">
        ...
        <h1 class="big__blue__title mb-4">TAC Urea Low Biuret</h1>
        <div class="row align-items-end">
            ...
            <div class="col-lg-4 col-md-6 order-1 order-md-2 text-md-end text-center">
                <img src="{{ asset('image/product/list/tac-urea-low-biuret.png') }}" alt=""
        ...
        <ul class="text__gray list__detail">
            ...
            <li> Fuel, oil, water, dust, dirt, and other contaminants should be kept away from the TAC Low Biuret Urea
                storage tank.
            </li>
        ...
        <ul class="text__gray list__detail">
            <li>Don’t add water or any other compounds into TAC Low Biuret Urea
            </li>
