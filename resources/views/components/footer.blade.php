<!-- Footer -->
<footer class="text-center text-lg-start text-white footer__blue">
    ...
    <section class="">
        <div class="container text-center text-md-start ">
            ...
            <div class="row ">
                ...
                <!-- Grid column -->
                <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mb-md-0 mb-4 info__alamat">
                    <!-- Links -->
                    <h5 class=" fw-bold mb-3 title__info">
                        Contact Us
                    </h5>
